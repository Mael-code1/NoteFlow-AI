...
const MarkdownEditor = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row p-4 space-y-4 md:space-x-4">
      ...
      <div className="w-full md:w-1/2 p-2 border border-gray-300 rounded-md bg-gray-50 text-black">
        <ReactMarkdown
          ...
          components={{
            ...
            h3: ({ children }) => (
              <h3 className="text-xl font-medium text-blue-300">{children}</h3>
            ),
